...
pub const PRODUCT_NAME: &str = "Codex Desktop 管理器";
    ...
    pub fn menu(self) -> NativeMenuCopy {
        match self {
            Self::En => NativeMenuCopy {
                about: "About Codex Desktop 管理器",
                services: "Services",
                hide: "Hide Codex Desktop 管理器",
                hide_others: "Hide Others",
                show_all: "Show All",
                quit: "Quit Codex Desktop 管理器",
                edit: "Edit",
                undo: "Undo",
                redo: "Redo",
                cut: "Cut",
            ...
            Self::ZhCn => NativeMenuCopy {
                about: "关于 Codex Desktop 管理器",
                services: "服务",
                hide: "隐藏 Codex Desktop 管理器",
                hide_others: "隐藏其他",
                show_all: "全部显示",
                quit: "退出 Codex Desktop 管理器",
                edit: "编辑",
                undo: "撤销",
                redo: "重做",
                cut: "剪切",
            ...
            Self::ZhTw => NativeMenuCopy {
                about: "關於 Codex Desktop 管理器",
                services: "服務",
                hide: "隱藏 Codex Desktop 管理器",
                hide_others: "隱藏其他",
                show_all: "全部顯示",
                quit: "結束 Codex Desktop 管理器",
                edit: "編輯",
                undo: "還原",
                redo: "重做",
                cut: "剪下",
            ...
            Self::Ja => NativeMenuCopy {
                about: "Codex Desktop 管理器について",
                services: "サービス",
                hide: "Codex Desktop 管理器を隠す",
                hide_others: "ほかを隠す",
                show_all: "すべてを表示",
                quit: "Codex Desktop 管理器を終了",
                edit: "編集",
                undo: "取り消す",
                redo: "やり直す",
                cut: "カット",
            ...
            Self::Ko => NativeMenuCopy {
                about: "Codex Desktop 管理器에 관하여",
                services: "서비스",
                hide: "Codex Desktop 管理器 가리기",
                hide_others: "기타 가리기",
                show_all: "모두 보기",
                quit: "Codex Desktop 管理器 종료",
                edit: "편집",
                undo: "실행 취소",
                redo: "실행 복귀",
                cut: "오려두기",
            ...
            Self::Fr => NativeMenuCopy {
                about: "À propos de Codex Desktop 管理器",
                services: "Services",
                hide: "Masquer Codex Desktop 管理器",
                hide_others: "Masquer les autres",
                show_all: "Tout afficher",
                quit: "Quitter Codex Desktop 管理器",
                edit: "Édition",
                undo: "Annuler",
                redo: "Rétablir",
                cut: "Couper",
            ...
            Self::De => NativeMenuCopy {
                about: "Über Codex Desktop 管理器",
                services: "Dienste",
                hide: "Codex Desktop 管理器 ausblenden",
                hide_others: "Andere ausblenden",
                show_all: "Alle einblenden",
                quit: "Codex Desktop 管理器 beenden",
                edit: "Bearbeiten",
                undo: "Widerrufen",
                redo: "Wiederholen",
                cut: "Ausschneiden",
            ...
            Self::Es => NativeMenuCopy {
                about: "Acerca de Codex Desktop 管理器",
                services: "Servicios",
                hide: "Ocultar Codex Desktop 管理器",
                hide_others: "Ocultar otros",
                show_all: "Mostrar todo",
                quit: "Salir de Codex Desktop 管理器",
                edit: "Edición",
                undo: "Deshacer",
                redo: "Rehacer",
                cut: "Cortar",
            ...
            Self::PtBr => NativeMenuCopy {
                about: "Sobre o Codex Desktop 管理器",
                services: "Serviços",
                hide: "Ocultar Codex Desktop 管理器",
                hide_others: "Ocultar Outros",
                show_all: "Mostrar Tudo",
                quit: "Encerrar Codex Desktop 管理器",
                edit: "Editar",
                undo: "Desfazer",
                redo: "Refazer",
                cut: "Cortar",
            ...
            Self::Ru => NativeMenuCopy {
                about: "О программе Codex Desktop 管理器",
                services: "Службы",
                hide: "Скрыть Codex Desktop 管理器",
                hide_others: "Скрыть остальные",
                show_all: "Показать все",
                quit: "Завершить Codex Desktop 管理器",
                edit: "Правка",
                undo: "Отменить",
                redo: "Повторить",
                cut: "Вырезать",
            ...
            Self::Ar => NativeMenuCopy {
                about: "حول Codex Desktop 管理器",
                services: "الخدمات",
                hide: "إخفاء Codex Desktop 管理器",
                hide_others: "إخفاء الآخرين",
                show_all: "إظهار الكل",
                quit: "إنهاء Codex Desktop 管理器",
                edit: "تحرير",
                undo: "تراجع",
                redo: "إعادة",
                cut: "قص",
...
mod tests {
    ...
    fn native_locale_maps_all_supported_tags_and_falls_back_to_english() {
        ...
        for (tag, locale) in cases {
            ...
            assert!(menu.quit.contains("Codex Desktop 管理器"), "{tag}:quit");
        }
