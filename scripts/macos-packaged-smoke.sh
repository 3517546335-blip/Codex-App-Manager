...
menu_copy() {
  case "$EXPECTED_LANG" in
    en) EDIT_MENU="Edit"; WINDOW_MENU="Window"; QUIT_ITEM="Quit Codex Desktop 管理器" ;;
    zh-CN) EDIT_MENU="编辑"; WINDOW_MENU="窗口"; QUIT_ITEM="退出 Codex Desktop 管理器" ;;
    zh-TW) EDIT_MENU="編輯"; WINDOW_MENU="視窗"; QUIT_ITEM="結束 Codex Desktop 管理器" ;;
    ja) EDIT_MENU="編集"; WINDOW_MENU="ウインドウ"; QUIT_ITEM="Codex Desktop 管理器を終了" ;;
    ko) EDIT_MENU="편집"; WINDOW_MENU="윈도우"; QUIT_ITEM="Codex Desktop 管理器 종료" ;;
    fr) EDIT_MENU="Édition"; WINDOW_MENU="Fenêtre"; QUIT_ITEM="Quitter Codex Desktop 管理器" ;;
    de) EDIT_MENU="Bearbeiten"; WINDOW_MENU="Fenster"; QUIT_ITEM="Codex Desktop 管理器 beenden" ;;
    es) EDIT_MENU="Edición"; WINDOW_MENU="Ventana"; QUIT_ITEM="Salir de Codex Desktop 管理器" ;;
    pt-BR) EDIT_MENU="Editar"; WINDOW_MENU="Janela"; QUIT_ITEM="Encerrar Codex Desktop 管理器" ;;
    ru) EDIT_MENU="Правка"; WINDOW_MENU="Окно"; QUIT_ITEM="Завершить Codex Desktop 管理器" ;;
    ar) EDIT_MENU="تحرير"; WINDOW_MENU="نافذة"; QUIT_ITEM="إنهاء Codex Desktop 管理器" ;;
...
assert_native_menu() {
  local pid=$1
  osascript - "$pid" "Codex Desktop 管理器" "$EDIT_MENU" "$WINDOW_MENU" "$QUIT_ITEM" <<'APPLESCRIPT'
on run argv
  set targetPid to (item 1 of argv) as integer
...
click_quit_menu() {
  local pid=$1
  osascript - "$pid" "Codex Desktop 管理器" "$QUIT_ITEM" >/dev/null <<'APPLESCRIPT'
on run argv
  set targetPid to (item 1 of argv) as integer
  set productName to item 2 of argv
...
[[ "$PRODUCT_NAME" == "Codex Desktop 管理器" ]] ||
