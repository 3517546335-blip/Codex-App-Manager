...
const CANDIDATE_BUNDLE_NAMES: [&str; 2] = ["ChatGPT.app", "Codex.app"];
...
mod tests {
    ...
    #[test]
    fn post_rebrand_bundle_name_is_canonical() {
        assert_eq!(CANDIDATE_BUNDLE_NAMES, ["ChatGPT.app", "Codex.app"]);
    }
